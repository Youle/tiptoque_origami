...
window.ajaxCart = {
  ...
  update: function(state) {
    ...
    window.synchronizeCollectionInputs && synchronizeCollectionInputs(state);
  ...
  _onItemDelete: function(evt) {
    ...
    utils.promiseAnimationEnd($item).then(
      function() {
        cart.removeItem(id).catch(this._onError.bind(this)).then(function(){
          window.synchronizeCollectionInputs && synchronizeCollectionInputs(cart.getLocalState());
        });
      }.bind(this)
    );
  },
